  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async{
        ...
        if(_homeStoryViewModel.sourceBooks.isNotEmpty){
          _homeStoryViewModel.ChangeSourceBook(_homeStoryViewModel.sourceBooks[0]);
        }
      },
      child: Scaffold(
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  if (Provider.of<HomeStoryViewModel>(context).stories.isEmpty)
